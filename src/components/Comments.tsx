    ...
    return(
        <div className=''>
            ...
            <div className='flex items-center gap-4'>
                <Image src='https://images.pexels.com/photos/28651765/pexels-photo-28651765/free-photo-of-serene-water-lily-bloom-on-peaceful-lake.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load'
            ...
            <div className=''>
                ...
                <div className='flex gap-4 justify-between mt-6'>
                    ...
                    <div className='flex flex-col gap-2 flex-1'>
                        ...
                        <p>Clerk handles authentication and user management for you. Next, learn how to
                            access this data and use it in your application,
                            customize the look and feel of your components, and get your Clerk app ready for production.</p>
                        <div className='flex items-center gap-8 text-xs text-gray-500'>
                            <div className='flex items-center gap-4'>
                                <Image src='/like.png'
                                       alt='' width={12} height={12} className='cursor-pointer'/>
